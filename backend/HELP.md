...
* The original package name 'com.example.project-three-event-management-system' is invalid and this project uses 'com.example.project_three_event_management_system' instead.
